 ...
 */
namespace Macapobres\Checkout\Model\Address\Validator;
...
class General implements ValidatorInterface
{
    ...
    public function validate(AbstractAddress $address)
    {
        ...
        error_log(print_r("overriden validate", true). "\n", 3, BP . "/var/log/data.log");
    ...
    private function checkRequiredFields(AbstractAddress $address)
    {
        ...
        if (!\Zend_Validate::is($address->getCity(), 'NotEmpty')) {
            //$errors[] = __('"%fieldName" is required. Enter and try again 12345.', ['fieldName' => 'city']);
        }
